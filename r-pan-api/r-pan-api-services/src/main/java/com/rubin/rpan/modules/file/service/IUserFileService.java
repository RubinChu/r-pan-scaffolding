...
import com.rubin.rpan.modules.file.po.FileSecUploadPO;
...
public interface IUserFileService {
    ...
    List<RPanUserFileVO> upload(MultipartFile file, Long parentId, Long userId, String md5, Long size);

    List<RPanUserFileVO> uploadWithChunk(MultipartFile file, Long parentId, Long userId, String md5, Integer chunks, Integer chunk, Long size, String name);
