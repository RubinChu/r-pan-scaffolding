...
public class UserFileServiceImpl implements IUserFileService {
     ...
     */
    @Override
    public List<RPanUserFileVO> upload(MultipartFile file, Long parentId, Long userId, String md5, Long size) {
     ...
     */
    @Override
    public List<RPanUserFileVO> uploadWithChunk(MultipartFile file, Long parentId, Long userId, String md5, Integer chunks, Integer chunk, Long size, String name) {
